...
if (!isset($_SESSION['user_id'])) {
    header("Location: ../../frontend/auth/login.php?redirect=favorites.php");
    exit();
}
...
// Include header (đường dẫn đúng)
include '../../frontend/pages/header.php';

// Kết nối CSDL (đường dẫn đúng)
...
<div class="container py-5">
            ...
            <?php foreach ($favorite_rooms as $room): ?>
                <div class="col-md-4 mb-4 room-card-container">
                    <div class="card feature-card h-100">
                        <img src="<?php echo !empty($room['image_url']) ? '../../frontend/assets/' . $room['image_url'] : 'https://via.placeholder.com/400x250'; ?>" class="card-img-top" alt="<?php echo htmlspecialchars($room['title']); ?>" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <a href="../../frontend/room/chi-tiet-phong.php?id=<?php echo $room['id']; ?>" class="text-decoration-none text-dark">
    ...
    <?php else: ?>
        <div class="alert alert-info p-5 text-center">
            ...
            <a href="../../frontend/room/phong.php" class="btn btn-warning px-4">Xem phòng trọ</a>
        </div>
    <?php endif; ?>
</div>
